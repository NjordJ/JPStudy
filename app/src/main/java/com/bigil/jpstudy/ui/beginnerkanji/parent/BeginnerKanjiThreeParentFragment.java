...
public class BeginnerKanjiThreeParentFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        final View root = inflater.inflate(R.layout.fragment_beginnerlistofkanjithree, container, false);
        ...
        try {
            ...
            for (int i=0; i<len; i++) {
                ...
                if(Integer.valueOf("3").equals(grade)){
