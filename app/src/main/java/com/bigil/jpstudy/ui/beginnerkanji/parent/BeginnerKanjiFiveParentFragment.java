...
public class BeginnerKanjiFiveParentFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        final View root = inflater.inflate(R.layout.fragment_beginnerlistofkanjifive, container, false);
        ...
        try {
            ...
            for (int i=0; i<len; i++) {
                ...
                if(Integer.valueOf("5").equals(grade)){
