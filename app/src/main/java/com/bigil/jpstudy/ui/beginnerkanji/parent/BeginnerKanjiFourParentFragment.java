...
public class BeginnerKanjiFourParentFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        final View root = inflater.inflate(R.layout.fragment_beginnerlistofkanjifour, container, false);
        ...
        try {
            ...
            for (int i=0; i<len; i++) {
                ...
                if(Integer.valueOf("4").equals(grade)){
